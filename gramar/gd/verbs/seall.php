...
<table class="table table-bordered text-center" style="max-width:800px;">
  ...
  <tbody>
    <tr><th>past</th><td colspan="3">sheall</td><td colspan="3">do sheall</td></tr>
...
<ul>
  ...
  <li><strong>“<mark>Seall ris an aghaidh</mark> aice ... <mark>Seall a-nise ris an dealbh</mark> sin.”</strong><br/>
    <small class="text-muted">“Look at her face ... Now look at that photograph.” [#2 67]</small></li>
  <li><strong>Nuair a thàinig bileag na cìse, <mark>sheall Elsie rithe</mark>.</strong><br/>
    <small class="text-muted">‘When the tax bill came, Elsie looked at it.’ [#2 26]</small></li>
</ul>
<p><strong>seall ri duine</strong> – ‘(turn to) look at someone’</p>
<ul>
  <li><strong><mark>Sheall Seòras ri mhàthair</mark> agus mhothaich i dhan cheist a bha na shùilean.</strong><br/>
    <small class="text-muted">‘George looked at his mother, and she noticed the question in his eyes.’ [#2 11]</small></li>
  <li><strong><mark>Sheall an duine ris</mark> le uabhas.</strong><br/>
    <small class="text-muted">‘The man looked at him in horror.’ [#2 11]</small></li>
...
<p><strong>seall</strong> + question ‘check if’, ‘(look and) see if’</p>
<ul>
...
<p><strong>seall mar a</strong> – ‘(look and) see how’, ‘check (out) how’</p>
<ul>
