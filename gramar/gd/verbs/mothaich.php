...
<ul>
  <li><strong>Sheall Seòras ri mhàthair agus <mark>mhothaich i dhan cheist</mark> a bha na shùilean.</strong><br/>
    <small class="text-muted">‘George looked at his mother and she noticed (saw) the question that was in his eyes.’ [#2 11]</small></li>
  <li><strong>“Cha <mark>mhothaicheadh tu dha</mark> air an t-sràid.”</strong><br/>
    <small class="text-muted"> “You would not notice (pay attention to) him in the street.” [#2 60]</small></li>
...
<ul>
  <li><strong>Chaidh trì uairean a thìde seachad mus do <mark>mhothaich duine gu robh</mark> Harry Heyford a dhìth.</strong><br/>
    <small class="text-muted">‘Three hours went past before anyone noticed that Harry Heyford was missing.’ [#2 62]</small></li>
  <li><strong>Bha e cinnteach nach <mark>mothaicheadh na mèirlich gun dh’atharraich</mark> e an cùrsa.</strong><br/>
    <small class="text-muted">‘He was certain that the thieves would not notice that he had changed the course.’ [#2 100]</small></li>
...
<ul>
  <li><strong>Nuair a bha iad a’ falbh, dh’fhaighnich fear aca dhomh na <mark>mhothaich mi an robh</mark> miotagan air na daoine, agus thuirt mi gu robh.</strong><br/>
    <small class="text-muted">‘When they were leaving, one of them asked me if I had noticed whether the men had gloves on, and I said that they did.’ [#2 15]</small></li>
  <li><strong>Ach chuala sinn mu dheidhinn Frank. <mark>Mhothaich feadhainn bho thìr-mòr cho sgileil ’s a bha</mark> e air a’ bhall-coise, agus cha b’ fhada gus an robh e ann an sgioba Avis Rovers.</strong><br/>
...
<p>Notes:</p>
<ul>
  <li><strong>mothaich</strong> does not appear to occur in the progressive (e.g. <em>tha mi a’ mothachadh ...</em>), suggesting that it is an ‘inchoative verb’, involving an instantaneous change of state.</li>
  <li><strong>mothaich</strong> occurs rarely in the imperative and in intentional constructions (e.g. <em>chaidh mi a mhothachadh ...</em>), suggesting that it is a ‘non-volitional’ verb.</li>
</ul>
<?php
