...
ORDER BY ?hw
SPQR;
$url = 'https://daerg.arts.gla.ac.uk/fuseki/Dago?output=json&query=' . urlencode($query);
if (getcwd()=='/Users/mark/Sites/gadelica/it') {
  $url = 'http://localhost:3030/Dago?output=json&query=' . urlencode($query);
}
