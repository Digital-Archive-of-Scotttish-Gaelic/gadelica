...
class TextModel {
  ...
  private $_date; // the year in which the text was published
  private $_publisher; // the group or individual which published the text
  private $_rating; // how important the text is for FnaG
  private $_superuri;
  private $_supertitle;
  private $_filename;
